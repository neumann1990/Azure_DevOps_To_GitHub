...
| 8 | War story / confession — [needs a concrete anecdote] | 2.0 |
| 9 | Q&A pocket | 1.0 |
...
| 3 | War story / confession — [needs a concrete anecdote] | 3.0 |
...
- **Two war-story/confession slides are still placeholders** (section 5, slide 8; section 6, slide 3). The abstract explicitly promises "confessions from teams who've already survived the trek" — these need real anecdotes before the deck is real, not just before it's polished.
